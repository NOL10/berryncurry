...
export const Route = createFileRoute("/fruits/shop")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse every mango, combo, and exotic organic fruit in season." },
      { property: "og:title", content: "Fruit Market — Berry and Curry" },
      { property: "og:description", content: "Browse every mango, combo, and exotic organic fruit in season." },
    ],
  }),
  component: Shop,
});
      ...
      <section className="border-b border-border/60">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-24">
          ...
          <h1 className="mt-3 max-w-3xl font-display text-5xl leading-[1.02] text-foreground sm:text-7xl">
            Everything in season, <span className="italic">right now.</span>
          </h1>
          <p className="mt-6 max-w-xl text-muted-foreground">{FRUIT_PRODUCTS.length} items · updated weekly with what's freshly picked.</p>
